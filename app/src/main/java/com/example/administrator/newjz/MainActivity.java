...
//--------------------------------------------------------------------------------
        ...
        ((HashMap) videoU[2]).put("key", "value");
...
//        jzvideoplayerstandard.startVideo(); //开始方法
        ...
        //---------------------------------音频-------------------
        musicView.setUp("https://onlyboss.oss-cn-beijing.aliyuncs.com/video_audio/zhanrundong/20190624/01/audio.mp3", "http://image.onlyboss.com/39/9ccef74e0006e114e1d894ae60ec7a.jpg");
